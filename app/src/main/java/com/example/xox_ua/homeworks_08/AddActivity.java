...
public class AddActivity extends BaseActivity {
    @BindView(R.id.etAddCountry) EditText etCountry;
    @BindView(R.id.etAddCapital) EditText etCapital;
    @BindView(R.id.etAddDescription) EditText etDescr;
    @BindView(R.id.addRating) RatingBar mRatingBar;
