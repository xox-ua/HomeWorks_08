...
class ListData {
    static String[] countryNames = { "Андорра", "Австрия", "Бельгия", "Кипр", "Чехия", "Германия", "Дания",
    ...
    static String[] capitalNames = { "Андорра-ла-Велья ", "Вена", "Брюссель", "Никосия", "Прага", "Берлин", "Копенгаген",
    ...
    static int[] flags = { R.drawable.zz_flg_and, R.drawable.zz_flg_aut, R.drawable.zz_flg_bel, R.drawable.zz_flg_cyp,
